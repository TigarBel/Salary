...
{
    [TestFixture]
    public class SalaryRateTest : PersonTest
    {
        /// <summary>
        /// Ставка
        /// </summary>
        ...
        public SalaryRateTest(string name, string suname, string patronymic, int age, double rate, int salary, string nameofwork)
        ...
        [Test]
        [TestCase(55, TestName = "Тестирование Fined при присваивании штрафа.")]
        /// <summary>
        /// Выписать штраф
        /// </summary>
